<template>
    <view>
        <!--
此文件为开发者工具生成，生成时间: 2021/7/8 下午3:43:52
使用方法：
在 C:\Users\Administrator\Desktop\my\wxmini_demo\pages\demo\index.wxml 引入模板
...
在 C:\Users\Administrator\Desktop\my\wxmini_demo\pages\demo\index.wxss 中引入样式
```
