    ...
    <view class="wrap">
        <view class="year_box">
            <view class="date-show">
                <view class="lt-arrow" @tap="lastMonth">
                    <image src="/static/img/de_icon3.png" mode="aspectFit"></image>
                </view>
                {{ year }}年{{ month }}月
                <view class="rt-arrow" @tap="nextMonth">
                    <image src="/static/img/de_icon2.png" mode="aspectFit"></image>
                </view>
            </view>
        </view>
