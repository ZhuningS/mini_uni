<template>
    <view>
        <!-- pages/jsCase/multiTime/index2.wxml -->
        <picker mode="multiSelector" @change="bindMultiPickerChange" @columnchange="bindMultiPickerColumnChange" :value="multiIndex" :range="multiArray">
            <input :value="time" disabled="" placeholder="选择时间" />
        </picker>
    </view>
</template>
...
export default {
    ...
    onLoad: function () {
        //设置默认的年份
        this.setData({
            choose_year: this.multiArray[0][0]
        });
    },
    methods: {
        //获取时间日期
        bindMultiPickerChange: function (e) {
            ...
            const minute = this.multiArray[4][index[4]]; // console.log(`${year}-${month}-${day}-${hour}-${minute}`);
