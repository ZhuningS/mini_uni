<template>
    <view>
        <!-- pages/jsCase/btnAudio/index.wxml -->
        <view class="confirm bubble" @tap.stop.prevent="audioPlay">点击按钮</view>
        <view class="confirm bubble" @tap.stop.prevent="cantcatme">联系我</view>
    </view>
</template>
