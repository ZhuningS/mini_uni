<template>
    <view>
        <!-- pages/effects/snow2/index.wxml -->
        <canvas :style="'width: 100%; height:' + canvasHeight + 'px'" canvas-id="myCanvas"></canvas>
    </view>
</template>
...
const snowImage = '/static/pages/effects/img/snow.png'; // const innerAudioContext = wx.createInnerAudioContext();
...
export default {
    ...
    onLoad: function () {
        ...
        let ticker = 0;
        let deltaTime = 0;
        let ctx = null; // 请求帧动画 实现循环生成 雪花实例
        ...
        init(); // innerAudioContext.autoplay = true;
        ...
        function init() {
            createCanvas(); // 小屏幕时延长添加雪花时间，避免屏幕上出现太多的雪花
