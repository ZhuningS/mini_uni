<template>
    <view class="content" v-if="isShowClone">
        ...
        <block v-else-if="type == '已选择开始时间'">
            <view class="title">请选择结束时间</view>
        </block>
        <block v-else-if="type == '已选择结束时间'">
            <view class="title">请提交选择</view>
        </block>
        ...
        <view class="box">
            <view class="calendar-box">
                ...
                <scroll-view scroll-y class="scroll-y" @scrolltolower="getCalendar">
                    <view class="calendar">
                        <block v-for="(item, index) in data" :key="index">
                            <view class="date">{{ item.year }}年{{ item.month }}月</view>

                            <view class="select-box" :data-test="item.weeks.length">
                                <block v-for="(week, i1) in item.weeks" :key="i1">
                                    <block v-for="(day, i2) in week" :key="i2">
...
export default {
    ...
    methods: {
        ...
        init() {
            ...
            let date = _date.getDate(); // 初始化当月数据
        ...
        editItem3(param) {
            ...
            console.log('结束日期', _item2); // 开始结束中间日期状态修改为'true'
        ...
        editItem4(param) {
            ...
            console.log('开始日期', _item1);
            console.log('结束日期', _item2); // 修改当前点击状态为'开始'
...
<style>
@import './date-more-selection.css';
</style>
