...
(function (undefined) {
    ...
    var Random = (function () {
        ...
        Random.extend({
            ...
            chineseName: function (count) {
                ...
                var forenames =
                    '贵福生龙元全国胜学祥才发武新利清飞彬富顺信子杰涛昌成康星光天达安岩中茂进林有坚和彪博绍功松善厚庆磊民友裕河哲江超浩亮政谦亨奇固之轮翰朗伯宏言若鸣朋斌梁栋维启克伦翔旭鹏月莺媛艳瑞凡佳嘉琼勤珍贞莉桂娣叶璧璐娅琦晶妍茜秋珊莎锦黛青倩婷姣婉娴瑾颖露瑶怡婵雁蓓'.split(
                        ''
                    );
    ...
    Handle.rule = function (name) {
        ...
        var parameters = (name || '').match(rkey),
            ...
            min = range && parseInt(range[1], 10),
            max = range && parseInt(range[2], 10),
            ...
            dmin = decimal && parseInt(decimal[1], 10),
            dmax = decimal && parseInt(decimal[2], 10),
        ...
        function prefilter(options, originalOptions, jqXHR) {
            ...
            if (item) {
                options.dataFilter =
                    ...
                    options.converters['script json'] =
                        function () {
