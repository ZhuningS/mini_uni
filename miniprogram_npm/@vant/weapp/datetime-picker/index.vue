...
export default {
    ...
    methods: {
        ...
        getPicker: function () {
            if (this.picker == null) {
                this.picker = this.$mp.page.selectComponent('.van-datetime-picker').$vm;
        ...
        updateColumns: function () {
            ...
            var formatter = _a === void 0 ? defaultFormatter : _a;
        ...
        getRanges: function () {
            ...
            var maxYear = _a.maxYear;
            var maxDate = _a.maxDate;
            var maxMonth = _a.maxMonth;
            var maxHour = _a.maxHour;
            var maxMinute = _a.maxMinute;
            var _b = this.getBoundary('min', data.innerValue);

            var minYear = _b.minYear;
            var minDate = _b.minDate;
            var minMonth = _b.minMonth;
            var minHour = _b.minHour;
            var minMinute = _b.minMinute;
            var result = [
                {
                    type: 'year',
