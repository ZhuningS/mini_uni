...
export default {
    ...
    methods: {
        getPicker: function () {
            if (this.picker == null) {
                this.picker = this.$mp.page.selectComponent('.van-area__picker').$vm;
            }
        ...
        parseValues: function (values) {
            var columnsPlaceholder = this.columnsPlaceholder;
        ...
        onChange: function (event) {
            ...
            var _b = event.detail;
            var index = _b.index;
            var picker = _b.picker;
            var value = _b.value;
            this.code = value[index].code;

            if ((_a = this.setValues()) === null || _a === void 0) {
                void 0;
            } else {
                _a.then(function () {
                    that.$emit('change', {
                        picker: picker,
                        values: that.parseValues(picker.getValues()),
                        index: index
                    });
                });
            }
        ...
        getList: function (type, code) {
            ...
            var typeToColumnsPlaceholder = this.typeToColumnsPlaceholder;
